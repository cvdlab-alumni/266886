...
window1 = STRUCT([T(3)(0.2)(window1up),T(3)(0.2)(window1down),T(3)(3.8)(window1down),T([1,3])([4.4,0.2])(window1up),T([1,3])([8.8,0.2])(window1up)])
eastwindows = T([1,2,3])([21,-19,16.5])(STRUCT([T(3)(-0.3)(window1),T(3)(6.9)(window1),T(3)(14.2)(window1)]))


window2up= COLOR([0,0,0])(GRID([   [0.2],[1],[4.6]     ]))
window2down = COLOR([0,0,0])(GRID([   [13],[1],[0.2]     ]))
window2 = T([1,2,3])([41,-17,16.5])(R([1,2])(PI/2)(STRUCT([  T(3)(-0.8)(window2up),T([1,3])([6.9,-0.8])(window2up),T([1,3])([12.8,-0.8])(window2up),T(3)(-1)(window2down),T(3)(3.8)(window2down)  ])))

window3up = COLOR([0,0,0])(GRID([  [0.2],[1],[9] ]) )
window3down = COLOR([0,0,0])(GRID([  [1.6],[1],[0.2] ]) )
window3 = T([1,2,3])([41,-2,11])(R([1,2])(PI/2)(STRUCT([   T(3)(0)(window3up),T([1,3])([1.8,0])(window3up),T(1)(0.2)(window3down),T([1,3])([0.2,4.4])(window3down),T([1,3])([0.2,8.8])(window3down)  ])))

northwindows = STRUCT([T(3)(-0.2)(window2),T(3)(8)(window2),T(3)(16)(window2),window3,T(3)(10)(window3),T(3)(20)(window3)])


window4up = COLOR([0,0,0])(GRID([[18],[1],[0.2]]))
window4down = COLOR([0,0,0])(GRID([[0.2],[1],[9]]))
window4 = T([1,2,3])([0.5,-18,11])(R([1,2])(PI/2)(STRUCT([  window4up,  T(1)(18)(window4down),T(1)(0)(window4down), T(1)(9)(window4down), T(3)(9)(window4up),   T(3)(5)(window4up)])))


southwindows = STRUCT([window4,T(3)(10)(window4)])

building = STRUCT([building,eastwindows,northwindows,southwindows])
VIEW(building)

step2d = MKPOL([[[0,0],[0,1.7],[2.66,1.7],[2.66,1.7],[2.66,0]],[[1,2,3,4,5]],None]);
